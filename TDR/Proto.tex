...
\includegraphics[width=0.45\columnwidth]{./Figures/Proto1t_Cryostat.jpg}
%\includegraphics[width=0.55\columnwidth]{./Figures/Cryogenics-Test-Layout-crop.pdf}
\includegraphics[width=0.50\columnwidth]{./Figures/Cryogenics-Test-Layout-2.pdf}
...
Assembly and test of the \DSks\ cryogenics will take place at \CERN, during the summer and last quarter of 2019. A layout of the complete test system currently under construction is displayed in Figure~\ref{fig:proto-cern}. 
The \DSks\ condenser box, as described in Section~\ref{sec:TPCCryo}, will be sitting and anchored on the top of several concrete blocks and elevated to the height of 3.4 m. This is to ensure that the gas/liquid argon mixture coming from the condenser unit can flow smoothly into the \DSps\ cryostat via the two 5 m long vacuum-insulated transfer lines. Two commercial gas circulation pumps, as well as argon and nitrogen gas panels will also be anchored onto the concrete blocks, in order to shorten the piping length. A LN2 supply system dedicated to this cryogenics test has been built by the \CERN\ cryogenics group. 
%Construction of \DSps\ is expected at the end of 2019 or early 2020. The first test operation with a reduced number of photosensors is expected by summer 2019, followed by a second operation with a full complement of \DSkPdms\ by early 2020. Full characterization of the prototype performance and physics runs will be performed after installation at LNGS. The detailed program of the activities to be carried out underground is under study.

Construction of \DSps\ is expected to begin in early 2020 to be completed by the next summer. Operations of the detector in surface at \CERN\ is foreseen through late 2020. Full characterization of the prototype in terms of physics performance in both ionization and scintillation 
measurement in low energy events, relevant for dark matter searches, would require a dedicated commissioning run underground at \LNGS. The detailed program of the activities to be carried underground and a plan for a 
temporary installation is under study.
...
A powerful test facility has to be prepared at Napoli, requiring extra man power. The procedures and the tools to ship the Motherboard from Pisa to Napoli and from Napoli to \CERN\ have been carefully planned and made available. 
